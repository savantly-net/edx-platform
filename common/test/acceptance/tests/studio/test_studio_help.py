...
class SignInHelpTest(WebAppTest):
    ...
    def test_sign_in_nav_help(self):
        ...
        assert_nav_help_link(self, sign_in_page, href, False)
...
class SignUpHelpTest(WebAppTest):
    ...
    def test_sign_up_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, sign_up_page, href, False)
...
class HomeHelpTest(StudioCourseTest):
    ...
    def test_course_home_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.home_page, href)
    ...
    def test_course_home_side_bar_help(self):
        ...
        # Assert that help link is correct.
        assert_side_bar_help_link(self, self.home_page, href, 'Getting Started with edX Studio', True)
...
class NewCourseHelpTest(WebAppTest):
    ...
    def test_course_create_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.dashboard_page, href)
    ...
    def test_course_create_side_bar_help(self):
        ...
        # Assert that help link is correct.
        assert_side_bar_help_link(self, self.dashboard_page, href, 'Getting Started with edX Studio', True)
...
class LibraryHelpTest(StudioLibraryTest):
    ...
    def test_library_content_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.library_page, href)
    ...
    def test_library_content_side_bar_help(self):
        ...
        # Assert that help link is correct.
        assert_side_bar_help_link(self, self.library_page, href, 'Learn more about content libraries')
    ...
    def test_library_user_access_setting_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.library_user_page, href)
...
class LibraryImportHelpTest(StudioLibraryTest):
    ...
    def test_library_import_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.library_import_page, href)
    ...
    def test_library_import_side_bar_help(self):
        ...
        # Assert that help link is correct.
        assert_side_bar_help_link(self, self.library_import_page, href, 'Learn more about importing a library')
...
class LibraryExportHelpTest(StudioLibraryTest):
    ...
    def test_library_export_nav_help(self):
        ...
        # Assert that help link is correct.
        assert_nav_help_link(self, self.library_export_page, href)
    ...
    def test_library_export_side_bar_help(self):
        ...
        # Assert that help link is correct.
        assert_side_bar_help_link(self, self.library_export_page, href, 'Learn more about exporting a library')
